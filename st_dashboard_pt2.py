...
#set path
path = r'https://github.com/nrschultz586/New_York_CitiBike_Analysis/tree/main/Data'
...
if page == "Interactive Map of Bike Trips":
    ...
    # Add the map
    path_to_html = 'C:/Users/nrsmi/Documents/CareerFoundry/New_York_CitiBike_Analysis/Bike Trips Aggregated.html'  # Ensure this file is available in the working directory
